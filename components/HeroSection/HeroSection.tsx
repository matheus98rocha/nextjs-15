...
export const HeroSection = ({
  ...
  return (
    <section className="animate-in fade-in w-screen bg-gradient-to-b from-primary to-pink-600 min-h-[530px] flex justify-center items-center flex-col py-10 px-6">
      ...
      <h1 className="rounded-sm fade-in-bottom-300 uppercase bg-black px-6 py-3 font-work-sans font-extrabold text-white sm:text-[54px] sm:leading-[64px] text-[36px] leading-[46px] max-w-5xl text-center my-5">
        {headingText}
      </h1>
      {children}
    </section>
